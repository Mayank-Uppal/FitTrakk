...
export default function Button({buttons}:Buttons) {
  return (
    <>
    {buttons.map((b)=>(
      <button type="submit" onClick={b.handleClick} key={b.id} className="group w-full relative inline-block overflow-hidden border border-green-400/50 px-10 py-3  md:px-8 md:py-4 rounded-md" >
