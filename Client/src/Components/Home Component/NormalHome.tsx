...
export default function NormalHome({homebuttons}:{homebuttons:buttonProp[]}) {
  ...
  return (
    ...
    <Header
        ...
        headingWidth="md:max-w-6xl text-white px-12 md:px-4"
        subHeadingWidth="md:max-w-5xl max-w-4xl px-12 md:px-4"
    />
        <div className="md:w-full md:max-w-xl mt-4 flex flex-col gap-4 ">
